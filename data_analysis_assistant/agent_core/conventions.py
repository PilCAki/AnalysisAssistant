...
class ConventionManager:
    ...
    def prompt_missing_conventions(
        self, ui_callback: Optional[Callable[[str, str, Optional[str]], str]] = None
    ) -> Dict[str, str]:
        """
        ...
        Args:
            ui_callback: Optional callback function for UI prompts.
                         Should accept (prompt, description, current_value) and
                         return user response. If None, falls back to input()
                         prompts.
        ...
        convention_prompts = {
            "time_column": {
                ...
                "description": (
                    "Column containing timestamps or dates for time series "
                    "analysis"
                ),
            },
            "id_column": {
                ...
                "description": (
                    "Column containing unique identifiers for each record"
                ),
            },
            "target_column": {
                "prompt": "What is your target column name?",
                "description": (
                    "Column containing the outcome/target variable for "
                    "prediction"
                ),
            },
        }
