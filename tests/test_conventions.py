...
class TestConventionManager(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        expected_keys = [
            "time_column", "id_column", "target_column", "numeric_columns",
            "category_columns", "date_format", "null_handling", "index_column",
            "created", "last_updated", "inferred", "user_confirmed"
        ]
    ...
    def test_get_set_methods(self):
        ...
        self.assertEqual(self.convention_manager.get("nonexistent_key", "default"), "default")
    ...
    def test_classify_columns(self):
        ...
        df = pd.DataFrame({
            ...
            "category_col": ["A", "B", "A"],
            "low_cardinality_numeric": [1, 1, 1],  # Should be treated as categorical (67% unique ratio, 2 unique vals)
    ...
    def test_prompt_missing_conventions_ui_callback(self):
        ...
        user_responses = self.convention_manager.prompt_missing_conventions(mock_ui_callback)
